...
VFAT_TO_SBIT_ELINK_ME0 = {
    0 : [3, 13, 5, 1, 0, 2, 12, 4],
    1 : [18, 21, 20, 23, 22, 27, 26, 25],
    2  : [17, 19, 14, 7, 9, 10, 15, 8],
    3  : [6, 7, 9, 4, 5, 2, 0, 1],
    4  : [15, 14, 12, 10, 11, 13, 19, 17],
    5  : [16, 18, 20, 22, 24, 26, 21, 23],
    6 : [3, 13, 5, 1, 0, 2, 12, 4],
    7 : [18, 21, 20, 23, 22, 27, 26, 25],
    8 : [17, 19, 14, 7, 9, 10, 15, 8],
    9 : [6, 7, 9, 4, 5, 2, 0, 1],
    10  : [15, 14, 12, 10, 11, 13, 19, 17],
    11  : [16, 18, 20, 22, 24, 26, 21, 23],
}
...
def lpgbt_vfat_sbit(system, vfat_list, nl1a, l1a_bxgap, best_phase):
    ...
    for phase in range(0, 16):
        ...
        write_backend_reg(get_rwreg_node("GEM_AMC.TTC.GENERATOR.CYCLIC_CALPULSE_TO_L1A_GAP"), 30)
...
if __name__ == '__main__':
    ...
    # Running Phase Scan
    try:
        lpgbt_vfat_sbit(args.system, vfat_list, nl1a, l1a_bxgap, args.bestphase)
