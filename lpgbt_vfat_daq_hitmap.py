...
def lpgbt_vfat_hitmap(system, oh_select, vfat_list, noise, low_thresh, cal_dac, nl1a, l1a_bxgap):
...
if __name__ == '__main__':
    ...
    # Running Phase Scan
    try:
        lpgbt_vfat_hitmap(args.system, int(args.ohid), vfat_list, args.noise, args.low_thresh, cal_dac, nl1a, l1a_bxgap)
