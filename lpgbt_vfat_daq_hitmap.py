...
def lpgbt_vfat_hitmap(system, vfat_list, noise, low_thresh, set_cal_mode, cal_dac, nl1a, l1a_bxgap):
...
if __name__ == '__main__':
    ...
    # Running Phase Scan
    try:
        lpgbt_vfat_hitmap(args.system, vfat_list, args.noise, args.low_thresh, cal_mode, cal_dac, nl1a, l1a_bxgap)
