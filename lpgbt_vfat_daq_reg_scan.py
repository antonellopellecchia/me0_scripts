...
def lpgbt_vfat_reg_scan(system, dac, vfat_list, channel_list, lower, upper, step, set_cal_mode, cal_dac, nl1a, l1a_bxgap):
...
if __name__ == '__main__':
    ...
    try:
        for reg in args.regs:
            lpgbt_vfat_reg_scan(args.system, reg, vfat_list, channel_list, lower, upper, step, cal_mode, cal_dac, nl1a, l1a_bxgap)
