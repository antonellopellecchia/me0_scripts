...
def lpgbt_vfat_sbit(system, vfat, elink_list, channel_list, sbit_list, parallel, set_cal_mode, cal_dac, nl1a, runtime, l1a_bxgap):
...
if __name__ == '__main__':
    ...
    # Running Phase Scan
    try:
        lpgbt_vfat_sbit(args.system, vfat, elink_list, channel_list, sbit_list, args.parallel, cal_mode, cal_dac, nl1a, runtime, l1a_bxgap)
