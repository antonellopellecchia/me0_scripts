...
def lpgbt_vfat_bert(system, vfat_list, set_cal_mode, cal_dac, nl1a, runtime, l1a_bxgap, calpulse):
    ...
    for vfat in vfat_list:
        ...
        write_backend_reg(get_rwreg_node("GEM_AMC.OH.OH%i.GEB.VFAT%i.CFG_CAL_DAC"% (oh_select, vfat-6*oh_select)), cal_dac)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-c", "--calpulse", action="store_true", dest="calpulse", help="if calpulsing for 1 channel for each VFAT should be enabled")
    ...
    parser.add_argument("-d", "--cal_dac", action="store", dest="cal_dac", default = "100", help="cal_dac = Value of CAL_DAC register (default = 100), only required when calpulsing")
    ...
    # Running Phase Scan
    try:
        lpgbt_vfat_bert(args.system, vfat_list, cal_mode, cal_dac, nl1a, runtime, l1a_bxgap, args.calpulse)
